...
class TakungpaoPipeline(object):
    def __init__(self):
        self.wb = Workbook()
    ...
    def process_item(self, item, spider):
        line = [item['timetoday'], item['fromwhere'], item['title'], item['content'], item['author'], item['url']]
        self.ws.append(line)
        self.wb.save(r"C:\Users\asus\Desktop\pydata\大公网.xlsx")
        return item

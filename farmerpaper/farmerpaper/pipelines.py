...
class FarmerpaperPipeline(object):
    def __init__(self):
        self.wb = Workbook()
        self.ws = self.wb.active
        self.ws.append(['时间', '标题', '内容', '记者', '来源', '链接'])

    def process_item(self, item, spider):
        line = [item['publishtime'], item['title'], item['content'], item['author'], item['fromwhere'], item['url']]
        self.ws.append(line)
        self.wb.save(r"C:\Users\asus\Desktop\pydata\农民日报.xlsx")
        return item

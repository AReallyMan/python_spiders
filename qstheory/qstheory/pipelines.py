...
class QstheoryPipeline(object):
    def __init__(self):
        self.wb = Workbook()
        self.ws = self.wb.active
        self.ws.append(['时间', '来源_作者', '标题', '内容', '链接'])

    def process_item(self, item, spider):
        line = [item['timetoday'], item['fromwhere_author'], item['title'], item['content'], item['url']]
        self.ws.append(line)
        self.wb.save(r"C:\Users\asus\Desktop\pydata\求是.xlsx")
        return item

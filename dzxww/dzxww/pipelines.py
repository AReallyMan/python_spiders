...
class DzxwwPipeline(object):
    def __init__(self):
        self.wb = Workbook()
        self.ws = self.wb.active
        self.ws.append(['时间', '来源', '标题', '内容', '编辑', 'url'])

    def process_item(self, item, spider):
        line = [item['time'], item['fromwhere'], item['title'], item['content'], item['editor'], item['url']]
        self.ws.append(line)
        self.wb.save((r"C:\Users\asus\Desktop\pydata\大众新闻网.xlsx"))
        return item

...
class ChinafarmerPipeline(object):
    def __init__(self):
        self.wb = Workbook()
        self.ws = self.wb.active
        self.ws.append(['时间', '来源', '标题', '内容', '作者', '编辑', '链接'])

    def process_item(self, item, spider):
        line = [item['createTime'], item['source'], item['title'], item['content'], item['author'], item['editor'], item['url']]
        self.ws.append(line)
        self.wb.save(r"C:\Users\asus\Desktop\pydata\中国农网.xlsx")
        return item

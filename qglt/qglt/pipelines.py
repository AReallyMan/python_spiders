...
class QgltPipeline(object):
    def __init__(self):
        self.wb = Workbook()
        self.ws = self.wb.active
        self.ws.append(['发布时间', '标题', '内容', '作者', '链接'])

    def process_item(self, item, spider):
        line = [item['publishtime'], item['title'], item['content'], item['author'], item['url']]
        self.ws.append(line)
        self.wb.save(r"C:\Users\asus\Desktop\强国论坛.xlsx")
        return item
